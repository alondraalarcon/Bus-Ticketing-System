              ...
              <div class="card">
                ...
                <div class="card-body">
                   <div class="float-right">
                    <a class="btn btn-primary" href="add-user.php"><i class="far fa-plus-square"></i> User</a>
                  </div>
                  <br/>

                  <h4 class="card-title">User Account's List</h4>
                 ...
                 <table id="example" class="table table-striped" style="width:100%">
                    ...
                    <?php
                        include("dbconni.php");
                        $ctr = 1;
                          $query = mysqli_query($con,"SELECT username,date,id_number,type FROM tbl_user WHERE type=0");
                          ...
                          <td>'.$row['date'].'</td>
                          <td>
                          <button type="button" class="btn btn-success" onclick="updatebus('.$row['id_number'].')"><i class="far fa-edit"></i> Edit</button>
                            <button type="button" class="btn btn-danger" onclick="ada('.$row['id_number'].')"><i class="fas fa-trash-restore-alt"></i> Delete</button>
...
<div id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
  ...
  <script type="text/javascript">
    ...
    var trans = 'updatebus';
    $.post("update-user-modal.php", {trans: trans, dtrans: idx}, function(data) {
      $("#customer").html(data);
    });
    ...
    function ada(idx){
      ...
      var trans = 'updatebus';
    $.post("delete-user-modal.php", {trans: trans, dtrans: idx}, function(data) {
